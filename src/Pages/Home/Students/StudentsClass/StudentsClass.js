    ...
    <div className={Classes.BG}>
      <div>
          <SelectingClass
            ...
            lable={HomeCTX.selectingClassStudents === null ? "Click Here" : HomeCTX.selectingClassStudents.selected}
          />
      </div>
      ...
      {props.showList ? (
        <StudentList
          ...
          update={props.update}
          // for showing null if class is changed
          ChangedClass={ChangedClass}
          ChangedClassToFlase={() => setChangedClass(false)}
          ChangedClassToTrue={() => setChangedClass(true)}
        />
      ) : null}
